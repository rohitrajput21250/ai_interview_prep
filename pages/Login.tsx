          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input type="checkbox" className="h-4 w-4 rounded border-white/10 bg-[#0a0a0a] text-indigo-500 focus:ring-indigo-500" />
                <label className="ml-2 block text-sm text-white/60">Remember me</label>
              </div>
